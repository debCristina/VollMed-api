...
public class ValidadorPacienteSemOutraConsulta implements ValidadorAgendamentoConsulta {
    ...
    public void validar (DadosAgendamentoConsulta dados) {
        ...
        var pacienteComOutraConsultaNoDia = repository.existsByPacienteIdAndDataBetweenAndMotivoCancelamentoIsNull(dados.idPaciente(), primeiroHorario, ultimoHorario);
