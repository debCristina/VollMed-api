...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioCenario1() {
        ...
        var paciente = cadastrarPaciente("paciente", "paciente@email.com","333.333.333-00");
        cadastrarConsulta(medico, paciente, proxSegundaAs10);
        //then ou assert
        var medicoLivre = medicoRepository.escolherMedicoAleatorio(Especialidade.CARDIOLOGIA, proxSegundaAs10);
